...
#     app.add_middleware(
#         CORSMiddleware,
#         allow_origins=os.getenv("ALLOWED_ORIGINS", "*").split(","),  # restrict in production
#         allow_credentials=True,
#         allow_methods=["*"],
#         allow_headers=["*"],
#     )
...
#                 "auto_grading": "operational",
#                 "quiz_generation": "operational",
...
#     logger.info(f"Starting AI Learning Services on {host}:{port}")
...
AI Learning Services - Production Ready
"""
